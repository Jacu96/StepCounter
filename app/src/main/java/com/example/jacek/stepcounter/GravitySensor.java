...
public class GravitySensor extends Service implements SensorEventListener {
    ...
    public void onCreate() {
        ...
        Sensor countSensor = sensorManager.getDefaultSensor(Sensor.TYPE_GRAVITY);
        if (countSensor != null) {
    ...
    public void sendStepsToMainActivity(float x, float y, float z) {
        ...
        intent.putExtra("x2", x);
        intent.putExtra("y2", y);
        intent.putExtra("z2", z);
        intent.putExtra("whichService", 2);
